...
//  NoobGame
//
//  Created by Thayllan Anacleto on 2019-02-20.
...
let restartLabel = SKLabelNode(fontNamed: "AlbaSuper")
...
class GameOverScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        let gameOverLabel = SKLabelNode(fontNamed: "AlbaSuper")
        ...
        let highScoreLabel = SKLabelNode(fontNamed: "AlbaSuper")
